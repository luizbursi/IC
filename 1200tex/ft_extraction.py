...
#código para a extração de dados de cada imagem da base de dados 1200TEX
...
path_1200tex = "C:/Users/oluiz/OneDrive/Documentos/IC/Bases/1200tex/"

#cria um vetor com os arquivos da base de dados 
dirs_1200tex = [file for file in os.listdir(path_1200tex) if file.endswith('.png')]
...
typefile_f = "_1200texFEAS.pkl"
typefile_c = "_1200texCLASS.pkl"
...
for descriptor in dirs_descriptors:     #ele vai fazer o laço no diretório com todas as funções extratoras de features
    ...
    for images in dirs_1200tex:  #laço que percorre as imagens dentro da base
        try:   
            img = cv2.imread(path_1200tex + images)  #parte de processamento de imagens
    ...
    path = path_pkl+descriptor+typefile_f
