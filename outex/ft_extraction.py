...
#código para a extração de dados de cada imagem da base de dados OUTEX
...
path_outex = "C:/Users/oluiz/OneDrive/Documentos/IC/Bases/outex/"

#cria um vetor com os arquivos da base de dados 
dirs_outex = [file for file in os.listdir(path_outex) if file.endswith('.png')]
...
typefile_f = "_outexFEAS.pkl"
typefile_c = "_outexCLASS.pkl"
...
for descriptor in dirs_descriptors:     #ele vai fazer o laço no diretório com todas as funções extratoras de features
    ...
    for images in dirs_outex:  #laço que percorre as imagens dentro da base
        try:   
            img = cv2.imread(path_outex + images)  #parte de processamento de imagens
